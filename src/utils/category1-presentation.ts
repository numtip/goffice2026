...
export const CAT1_MANAGEMENT_CYCLE: CycleStep[] = [
  {
    ...
    code: 'define',
    label: {
      th: 'การกำหนดแนวทางการดำเนินงานสำนักงานสีเขียว',
      en: 'Defining Green Office Operational Guidelines',
    },
  ...
  },
  {
    issue: '1.2',
    code: 'govern',
    label: { th: 'คณะทำงานด้านสิ่งแวดล้อม', en: 'Environmental Working Team' },
  ...
  },
  {
    ...
    code: 'identify',
    label: {
      th: 'การระบุประเด็นปัญหาทรัพยากรและสิ่งแวดล้อม',
      en: 'Identification of Resource and Environmental Issues',
    },
  ...
  },
  {
    issue: '1.4',
    code: 'comply',
    label: { th: 'กฎหมายและข้อกำหนดอื่นๆ ที่เกี่ยวข้อง', en: 'Relevant Laws and Regulations' },
  ...
  },
  {
    issue: '1.5',
    code: 'measure',
    label: { th: 'ข้อมูลก๊าซเรือนกระจก', en: 'Greenhouse Gas Data' },
  ...
  },
  {
    ...
    code: 'improve',
    label: {
      th: 'แผนการดำเนินงานและโครงการเพื่อมุ่งสู่การลดก๊าซเรือนกระจกของหน่วยงาน',
      en: 'GHG Reduction Plans and Projects',
    },
  ...
  },
  {
    issue: '1.7',
    code: 'review',
    label: { th: 'การทบทวนฝ่ายบริหาร', en: 'Management Review' },
