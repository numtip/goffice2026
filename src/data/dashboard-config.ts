...
const dashboards: DashboardMeta[] = [
  ...
  },
  {
    ...
    description: 'Review waste mass (kg) segregated and disposed, with recycling rate shown separately — aligned to Green Office หมวดที่ 4 การจัดการของเสีย.',
    descriptionTh: 'ติดตามปริมาณขยะ (กิโลกรัม) ที่คัดแยกและกำจัด โดยแสดงอัตราการรีไซเคิลแยกต่างหาก ตามเกณฑ์ Green Office หมวดที่ 4 การจัดการของเสีย',
    categoryId: 'cat4',
    csvFile: 'waste.csv',
    kpiField: 'total_kg',
    kpiUnit: 'kg',
    color: '#7c3aed',
    sourceLabel: 'Waste mass records (kg) — 1.5waste2026.xlsx',
    sourceLabelTh: 'บันทึกปริมาณขยะ (กก.) — 1.5waste2026.xlsx',
  },
  {
    id: 'ghg',
    title: 'GHG Emissions Dashboard',
    titleTh: 'แดชบอร์ดการปล่อยก๊าซเรือนกระจก',
    description: 'Track Scope 1, 2, and 3 greenhouse gas emissions (tCO₂e) and reduction progress — aligned to Green Office Category 1 (Environmental Policy and Planning): 1.1.3 target → 1.5.1 GHG inventory → 1.5.2 analysis → 1.6 improvement → 1.7 review.',
    descriptionTh: 'ติดตามการปล่อยก๊าซเรือนกระจกขอบเขตที่ 1, 2 และ 3 (tCO₂e) และความคืบหน้าการลดการปล่อยก๊าซ ตามเกณฑ์ Green Office หมวดที่ 1 การกำหนดนโยบาย การวางแผนการดำเนินงาน: 1.1.3 เป้าหมาย → 1.5.1 เก็บข้อมูล GHG → 1.5.2 วิเคราะห์ → 1.6 ปรับปรุง → 1.7 ทบทวน',
    categoryId: 'cat1',
    csvFile: 'ghg.csv',
